...
This is substantially similar to the inference from our `ulam` script and the frequentist analysis. However, the regression intervals and prediction intervals are slightly narrower, presumably because the default priors are a little bit informative. We'll look at the priors next.
